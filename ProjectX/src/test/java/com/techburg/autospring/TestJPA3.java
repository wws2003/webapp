...
public class TestJPA3 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			mBuildInfoPersistenceService = applicationContext.getBean("buildInfoPersistenceService",
					IBuildInfoPersistenceService.class);
			mBuildScriptPersistenceService = applicationContext.getBean("buildScriptPersistenceService",
					IWorkspacePersistenceService.class);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
	...
	public void testPersist() {
		...
		WorkspacePersistenceQuery query2 = WorkspacePersistenceQuery.createQueryById(1);
	...
	public void testUpdate() {
		...
		List<Workspace> buildScripts = new ArrayList<Workspace>();
		WorkspacePersistenceQuery query2 = WorkspacePersistenceQuery.createWorkspaceQueryForAll();
		mBuildScriptPersistenceService.loadWorkspace(buildScripts, query2);
